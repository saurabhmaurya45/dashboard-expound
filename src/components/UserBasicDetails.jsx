    ...
    <>
      ...
      <div className="flex h-full flex-col items-start gap-4 p-4">
        ...
        <div className="flex items-center flex-col md:flex-row gap-2">
          <button className="bg-green-100 text-green-600 hover:bg-green-200 hover:text-green-700 px-4 py-2 rounded-sm font-semibold text-sm">
            Create Account
          </button>
          <button className="bg-yellow-100 text-yellow-600 hover:bg-yellow-200 hover:text-yellow-700 px-4 py-2 rounded-sm font-semibold text-sm">
            Create Contact
          </button>
        </div>
      </div>
