...
const TaskCard = ({ task }) => {
    ...
    return (
        <div className="w-[240px] flex flex-col bg-white rounded-sm border text-sm">
            <div className="w-[240px] flex items-center border-b py-1 ">
    ...
    return (
        <div className="flex flex-col p-4 w-full">
            <div className='flex items-center justify-between text-blue-900'>
                ...
                <button className="underline font-semibold px-4 rounded focus:outline-none focus:shadow-outline">View All</button>
            </div>

            <div className="flex gap-4 py-2 overflow-scroll no-scrollbar">
                {tasks.map((task) => (
